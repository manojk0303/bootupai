...
<div className="p-3 sm:p-4 md:p-6">
  {Object.entries(referrals).map(([service, links]) => (
    <div key={service} className="mb-6 last:mb-0">
      <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mb-3 sm:mb-4 flex items-center flex-wrap">
        {service}
          ...
          <table className="w-full table-fixed">
            <thead>
              <tr className="bg-gray-50 text-gray-600 text-sm">
                <th className="p-3 text-left w-1/6">Service</th>
                <th className="p-3 text-left w-1/6">Referral Code</th>
                <th className="p-3 text-left w-1/4">Referral Link</th>
                <th className="p-3 text-left w-1/6">Created</th>
                <th className="p-3 text-center w-1/12">Sign Ups</th>
                <th className="p-3 text-right w-1/12">Actions</th>
              </tr>
            </thead>
            <tbody>
              {links.map((referral) => (
                ...
                >
                  <td className="p-3 font-medium text-gray-800 break-words">{referral.service}</td>
                  <td className="p-3">
                  ...
                  <td className="p-3">
                    <div className="flex items-center gap-2 flex-wrap">
                      <span className="truncate text-blue-600 break-all">
