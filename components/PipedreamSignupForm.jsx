...
export default function PipedreamSignupForm({ service, creator }) {
      ...
      <div className="w-full max-w-lg bg-white py-8 px-6 shadow-xl sm:rounded-lg sm:px-10 relative overflow-hidden transition-all duration-300 p-5">
        ...
        {accountCreated ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
            ...
            <div>
              ...
              <div className="mt-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-1 mt-1">
                  <div className={`text-xs flex items-center ${passwordValidation.uppercase ? 'text-green-600' : 'text-gray-500'}`}>
                    <svg className={`h-4 w-4 mr-1 ${passwordValidation.uppercase ? 'text-green-500' : 'text-gray-400'}`} fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <div className={`text-xs flex items-center ${passwordValidation.lowercase ? 'text-green-600' : 'text-gray-500'}`}>
                    <svg className={`h-4 w-4 mr-1 ${passwordValidation.lowercase ? 'text-green-500' : 'text-gray-400'}`} fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <div className={`text-xs flex items-center ${passwordValidation.number ? 'text-green-600' : 'text-gray-500'}`}>
                    <svg className={`h-4 w-4 mr-1 ${passwordValidation.number ? 'text-green-500' : 'text-gray-400'}`} fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <div className={`text-xs flex items-center ${passwordValidation.special ? 'text-green-600' : 'text-gray-500'}`}>
                    <svg className={`h-4 w-4 mr-1 ${passwordValidation.special ? 'text-green-500' : 'text-gray-400'}`} fill="currentColor" viewBox="0 0 20 20">
            ...
            <button
              type="submit"
              disabled={isSubmitting || !email || !isPasswordValid || !buildingPurpose}
